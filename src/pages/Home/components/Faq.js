...
export const Faq = () => {
  ...
  return (
    <section className="flex items-center justify-center max-w-6xl mx-24  my-10 p-7 border rounded dark:border-slate-700 shadow-sm">
      <div className="item-cenetr w-full ">
